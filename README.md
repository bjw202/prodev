...
| `design/v2/ADR.md` | 왜 그렇게 정했나. 결정 **스물아홉**과 근거 | "왜 이렇게 했지" 싶을 때 |
| `design/v2/TASKS.md` | 누가 언제 무엇을. 단계 넷 · 관문 넷 | 일을 고를 때 |
| `design/v2/VERIFICATION.md` | 어떻게 검수하나. 층 A~D · 단위 시험 · **세션 대 세션 대본** · 예측표 | 관문마다 |

**v1 과 무엇이 다른가** 검색 안정성 고침이다 (ADR-026~029). 찾기 층에 과제 문서(헌장 · 일정)를 더해 여섯이 되었고, 카드 `## 결과` 절이 갈래별 요약 표와 원본 실마리를 둘 다 싣게 되었고, 대본 시험이 미니디스코드 없이 세션 대 세션으로 바뀌었다.
